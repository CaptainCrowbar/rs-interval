...
void test_rs_interval_integral_interval_complement() {
    ...
    TRY((in = 42));            TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=41,>=43}");
    TRY((in = {42,42,"<"}));   TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{>=42}");
    TRY((in = {42,42,"<="}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{>=43}");
    TRY((in = {42,42,">"}));   TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=42}");
    TRY((in = {42,42,">="}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=41}");
    TRY((in = {86,99,"()"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=86,>=99}");
    TRY((in = {86,99,"(]"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=86,>=100}");
    TRY((in = {86,99,"[)"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=85,>=99}");
    TRY((in = {86,99,"[]"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=85,>=100}");
