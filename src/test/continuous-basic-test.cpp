...
static_assert(std::same_as<Itv::value_type, double>);
...
void test_rs_interval_continuous_interval_construction() {
    ...
    TRY(in = Itv());                                      TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");     TEST_EQUAL(in.size(), 0);
    TRY(in = Itv(1.0));                                   TRY(str = std::format("{}", in));  TEST_EQUAL(str, "1");      TEST_EQUAL(in.size(), 0);
    TRY(in = Itv(1.0, Bound::closed, Bound::closed));     TRY(str = std::format("{}", in));  TEST_EQUAL(str, "1");      TEST_EQUAL(in.size(), 0);
    TRY(in = Itv(1.0, Bound::closed, Bound::open));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");     TEST_EQUAL(in.size(), 0);
    TRY(in = Itv(1.0, Bound::open, Bound::closed));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");     TEST_EQUAL(in.size(), 0);
    TRY(in = Itv(1.0, Bound::closed, Bound::unbound));    TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=1");    TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, Bound::unbound, Bound::closed));    TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=1");    TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, Bound::open, Bound::unbound));      TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">1");     TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, Bound::unbound, Bound::open));      TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<1");     TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, Bound::unbound, Bound::unbound));   TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");      TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, 2.0));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, Bound::closed));               TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, Bound::open));                 TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2)");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, Bound::closed, Bound::open));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2)");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, Bound::open, Bound::closed));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2]");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, "[]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, "()"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2)");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, "[)"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2)");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, "(]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2]");  TEST_EQUAL(in.size(), 1);
    TRY(in = Itv(1.0, 2.0, "<"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<2");     TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, 2.0, "<="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=2");    TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, 2.0, ">"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">1");     TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, 2.0, ">="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=1");    TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(1.0, 2.0, "*"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");      TEST_EQUAL(in.size(), inf);
    TRY(in = Itv(2.0, 1.0));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");     TEST_EQUAL(in.size(), 0);

    TRY(in = make_interval(1.0));                                   TRY(str = std::format("{}", in));  TEST_EQUAL(str, "1");
    TRY(in = make_interval(1.0, Bound::closed, Bound::closed));     TRY(str = std::format("{}", in));  TEST_EQUAL(str, "1");
    TRY(in = make_interval(1.0, Bound::closed, Bound::open));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");
    TRY(in = make_interval(1.0, Bound::open, Bound::closed));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");
    TRY(in = make_interval(1.0, Bound::closed, Bound::unbound));    TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=1");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::closed));    TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=1");
    TRY(in = make_interval(1.0, Bound::open, Bound::unbound));      TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">1");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::open));      TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<1");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::unbound));   TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");
    TRY(in = make_interval(1.0, 2.0));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");
    TRY(in = make_interval(1.0, 2.0, Bound::closed));               TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");
    TRY(in = make_interval(1.0, 2.0, Bound::open));                 TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2)");
    TRY(in = make_interval(1.0, 2.0, Bound::closed, Bound::open));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2)");
    TRY(in = make_interval(1.0, 2.0, Bound::open, Bound::closed));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2]");
    TRY(in = make_interval(1.0, 2.0, "[]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");
    TRY(in = make_interval(1.0, 2.0, "()"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2)");
    TRY(in = make_interval(1.0, 2.0, "[)"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2)");
    TRY(in = make_interval(1.0, 2.0, "(]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2]");
    TRY(in = make_interval(1.0, 2.0, "<"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<2");
    TRY(in = make_interval(1.0, 2.0, "<="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=2");
    TRY(in = make_interval(1.0, 2.0, ">"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">1");
    TRY(in = make_interval(1.0, 2.0, ">="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=1");
    TRY(in = make_interval(1.0, 2.0, "*"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");
    TRY(in = make_interval(2.0, 1.0));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");

    TRY(in = ordered_interval(2.0, 1.0));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");
    TRY(in = ordered_interval(2.0, 1.0, Bound::closed));               TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2]");
    TRY(in = ordered_interval(2.0, 1.0, Bound::open));                 TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2)");
    TRY(in = ordered_interval(2.0, 1.0, Bound::closed, Bound::open));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(1,2]");
    TRY(in = ordered_interval(2.0, 1.0, Bound::open, Bound::closed));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[1,2)");
...
void test_rs_interval_continuous_interval_to_string() {
    ...
    TRY(in = make_interval(1.0));                                   TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc1xyz");
    TRY(in = make_interval(1.0, Bound::closed, Bound::closed));     TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc1xyz");
    TRY(in = make_interval(1.0, Bound::closed, Bound::open));       TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc{}xyz");
    TRY(in = make_interval(1.0, Bound::open, Bound::closed));       TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc{}xyz");
    TRY(in = make_interval(1.0, Bound::closed, Bound::unbound));    TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc>=1xyz");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::closed));    TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc<=1xyz");
    TRY(in = make_interval(1.0, Bound::open, Bound::unbound));      TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc>1xyz");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::open));      TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc<1xyz");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::unbound));   TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc*xyz");
    TRY(in = make_interval(1.0, 2.0));                              TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc[1,2]xyz");
    TRY(in = make_interval(1.0, 2.0, Bound::closed));               TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc[1,2]xyz");
    TRY(in = make_interval(1.0, 2.0, Bound::open));                 TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc(1,2)xyz");
    TRY(in = make_interval(1.0, 2.0, Bound::closed, Bound::open));  TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc[1,2)xyz");
    TRY(in = make_interval(1.0, 2.0, Bound::open, Bound::closed));  TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc(1,2]xyz");
    TRY(in = make_interval(1.0, 2.0, "[]"));                        TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc[1,2]xyz");
    TRY(in = make_interval(1.0, 2.0, "()"));                        TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc(1,2)xyz");
    TRY(in = make_interval(1.0, 2.0, "[)"));                        TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc[1,2)xyz");
    TRY(in = make_interval(1.0, 2.0, "(]"));                        TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc(1,2]xyz");
    TRY(in = make_interval(1.0, 2.0, "<"));                         TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc<2xyz");
    TRY(in = make_interval(1.0, 2.0, "<="));                        TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc<=2xyz");
    TRY(in = make_interval(1.0, 2.0, ">"));                         TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc>1xyz");
    TRY(in = make_interval(1.0, 2.0, ">="));                        TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc>=1xyz");
    TRY(in = make_interval(1.0, 2.0, "*"));                         TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc*xyz");
    TRY(in = make_interval(2.0, 1.0));                              TRY(str = std::format("abc{}xyz", in));  TEST_EQUAL(str, "abc{}xyz");

    TRY(in = make_interval(1.0));                                   TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "1.00");
    TRY(in = make_interval(1.0, Bound::closed, Bound::closed));     TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "1.00");
    TRY(in = make_interval(1.0, Bound::closed, Bound::open));       TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "{}");
    TRY(in = make_interval(1.0, Bound::open, Bound::closed));       TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "{}");
    TRY(in = make_interval(1.0, Bound::closed, Bound::unbound));    TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, ">=1.00");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::closed));    TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "<=1.00");
    TRY(in = make_interval(1.0, Bound::open, Bound::unbound));      TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, ">1.00");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::open));      TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "<1.00");
    TRY(in = make_interval(1.0, Bound::unbound, Bound::unbound));   TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "*");
    TRY(in = make_interval(1.0, 2.0));                              TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "[1.00,2.00]");
    TRY(in = make_interval(1.0, 2.0, Bound::closed));               TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "[1.00,2.00]");
    TRY(in = make_interval(1.0, 2.0, Bound::open));                 TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "(1.00,2.00)");
    TRY(in = make_interval(1.0, 2.0, Bound::closed, Bound::open));  TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "[1.00,2.00)");
    TRY(in = make_interval(1.0, 2.0, Bound::open, Bound::closed));  TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "(1.00,2.00]");
    TRY(in = make_interval(1.0, 2.0, "[]"));                        TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "[1.00,2.00]");
    TRY(in = make_interval(1.0, 2.0, "()"));                        TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "(1.00,2.00)");
    TRY(in = make_interval(1.0, 2.0, "[)"));                        TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "[1.00,2.00)");
    TRY(in = make_interval(1.0, 2.0, "(]"));                        TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "(1.00,2.00]");
    TRY(in = make_interval(1.0, 2.0, "<"));                         TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "<2.00");
    TRY(in = make_interval(1.0, 2.0, "<="));                        TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "<=2.00");
    TRY(in = make_interval(1.0, 2.0, ">"));                         TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, ">1.00");
    TRY(in = make_interval(1.0, 2.0, ">="));                        TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, ">=1.00");
    TRY(in = make_interval(1.0, 2.0, "*"));                         TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "*");
    TRY(in = make_interval(2.0, 1.0));                              TRY(str = std::format("{:.2f}", in));  TEST_EQUAL(str, "{}");
...
void test_rs_interval_continuous_interval_complement() {
    ...
    TRY((in = 42));            TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<42,>42}");
    TRY((in = {42,42,"<"}));   TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{>=42}");
    TRY((in = {42,42,"<="}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{>42}");
    TRY((in = {42,42,">"}));   TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=42}");
    TRY((in = {42,42,">="}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<42}");
    TRY((in = {86,99,"()"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=86,>=99}");
    TRY((in = {86,99,"(]"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<=86,>99}");
    TRY((in = {86,99,"[)"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<86,>=99}");
    TRY((in = {86,99,"[]"}));  TRY(set = in.complement());  TRY(str = std::format("{}", set));  TEST_EQUAL(str, "{<86,>99}");
