...
static_assert(std::same_as<Itv::value_type, std::string>);
...
void test_rs_interval_ordered_interval_construction() {
    ...
    TRY(in = Itv("a"));                                   TRY(str = std::format("{}", in));  TEST_EQUAL(str, "a");
    TRY(in = Itv("a", Bound::closed, Bound::closed));     TRY(str = std::format("{}", in));  TEST_EQUAL(str, "a");
    TRY(in = Itv("a", Bound::closed, Bound::open));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");
    TRY(in = Itv("a", Bound::open, Bound::closed));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");
    TRY(in = Itv("a", Bound::closed, Bound::unbound));    TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=a");
    TRY(in = Itv("a", Bound::unbound, Bound::closed));    TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=a");
    TRY(in = Itv("a", Bound::open, Bound::unbound));      TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">a");
    TRY(in = Itv("a", Bound::unbound, Bound::open));      TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<a");
    TRY(in = Itv("a", Bound::unbound, Bound::unbound));   TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");
    TRY(in = Itv("a", "z"));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z]");
    TRY(in = Itv("a", "z", Bound::closed));               TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z]");
    TRY(in = Itv("a", "z", Bound::open));                 TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z)");
    TRY(in = Itv("a", "z", Bound::closed, Bound::open));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z)");
    TRY(in = Itv("a", "z", Bound::open, Bound::closed));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z]");
    TRY(in = Itv("a", "z", "[]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z]");
    TRY(in = Itv("a", "z", "()"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z)");
    TRY(in = Itv("a", "z", "[)"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z)");
    TRY(in = Itv("a", "z", "(]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z]");
    TRY(in = Itv("a", "z", "<"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<z");
    TRY(in = Itv("a", "z", "<="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=z");
    TRY(in = Itv("a", "z", ">"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">a");
    TRY(in = Itv("a", "z", ">="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=a");
    TRY(in = Itv("a", "z", "*"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");
    TRY(in = Itv("z", "a"));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");

    TRY(in = make_interval("a"s));                                    TRY(str = std::format("{}", in));  TEST_EQUAL(str, "a");
    TRY(in = make_interval("a"s, Bound::closed, Bound::closed));      TRY(str = std::format("{}", in));  TEST_EQUAL(str, "a");
    TRY(in = make_interval("a"s, Bound::closed, Bound::open));        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");
    TRY(in = make_interval("a"s, Bound::open, Bound::closed));        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");
    TRY(in = make_interval("a"s, Bound::closed, Bound::unbound));     TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=a");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::closed));     TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=a");
    TRY(in = make_interval("a"s, Bound::open, Bound::unbound));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">a");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::open));       TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<a");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::unbound));    TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");
    TRY(in = make_interval("a"s, "z"s));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z]");
    TRY(in = make_interval("a"s, "z"s, Bound::closed));               TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z]");
    TRY(in = make_interval("a"s, "z"s, Bound::open));                 TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z)");
    TRY(in = make_interval("a"s, "z"s, Bound::closed, Bound::open));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z)");
    TRY(in = make_interval("a"s, "z"s, Bound::open, Bound::closed));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z]");
    TRY(in = make_interval("a"s, "z"s, "[]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z]");
    TRY(in = make_interval("a"s, "z"s, "()"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z)");
    TRY(in = make_interval("a"s, "z"s, "[)"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z)");
    TRY(in = make_interval("a"s, "z"s, "(]"));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z]");
    TRY(in = make_interval("a"s, "z"s, "<"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<z");
    TRY(in = make_interval("a"s, "z"s, "<="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, "<=z");
    TRY(in = make_interval("a"s, "z"s, ">"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">a");
    TRY(in = make_interval("a"s, "z"s, ">="));                        TRY(str = std::format("{}", in));  TEST_EQUAL(str, ">=a");
    TRY(in = make_interval("a"s, "z"s, "*"));                         TRY(str = std::format("{}", in));  TEST_EQUAL(str, "*");
    TRY(in = make_interval("z"s, "a"s));                              TRY(str = std::format("{}", in));  TEST_EQUAL(str, "{}");

    TRY(in = ordered_interval("z"s, "a"s, Bound::closed));               TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z]");
    TRY(in = ordered_interval("z"s, "a"s, Bound::open));                 TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z)");
    TRY(in = ordered_interval("z"s, "a"s, Bound::closed, Bound::open));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "(a,z]");
    TRY(in = ordered_interval("z"s, "a"s, Bound::open, Bound::closed));  TRY(str = std::format("{}", in));  TEST_EQUAL(str, "[a,z)");
...
void test_rs_interval_ordered_interval_to_string() {
    ...
    TRY(in = make_interval("a"s));                                    TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123a456");
    TRY(in = make_interval("a"s, Bound::closed, Bound::closed));      TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123a456");
    TRY(in = make_interval("a"s, Bound::closed, Bound::open));        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123{}456");
    TRY(in = make_interval("a"s, Bound::open, Bound::closed));        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123{}456");
    TRY(in = make_interval("a"s, Bound::closed, Bound::unbound));     TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123>=a456");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::closed));     TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123<=a456");
    TRY(in = make_interval("a"s, Bound::open, Bound::unbound));       TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123>a456");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::open));       TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123<a456");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::unbound));    TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123*456");
    TRY(in = make_interval("a"s, "z"s));                              TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123[a,z]456");
    TRY(in = make_interval("a"s, "z"s, Bound::closed));               TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123[a,z]456");
    TRY(in = make_interval("a"s, "z"s, Bound::open));                 TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123(a,z)456");
    TRY(in = make_interval("a"s, "z"s, Bound::closed, Bound::open));  TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123[a,z)456");
    TRY(in = make_interval("a"s, "z"s, Bound::open, Bound::closed));  TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123(a,z]456");
    TRY(in = make_interval("a"s, "z"s, "[]"));                        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123[a,z]456");
    TRY(in = make_interval("a"s, "z"s, "()"));                        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123(a,z)456");
    TRY(in = make_interval("a"s, "z"s, "[)"));                        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123[a,z)456");
    TRY(in = make_interval("a"s, "z"s, "(]"));                        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123(a,z]456");
    TRY(in = make_interval("a"s, "z"s, "<"));                         TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123<z456");
    TRY(in = make_interval("a"s, "z"s, "<="));                        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123<=z456");
    TRY(in = make_interval("a"s, "z"s, ">"));                         TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123>a456");
    TRY(in = make_interval("a"s, "z"s, ">="));                        TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123>=a456");
    TRY(in = make_interval("a"s, "z"s, "*"));                         TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123*456");
    TRY(in = make_interval("z"s, "a"s));                              TRY(str = std::format("123{}456", in));  TEST_EQUAL(str, "123{}456");

    TRY(in = make_interval("a"s));                                    TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"("a")");
    TRY(in = make_interval("a"s, Bound::closed, Bound::closed));      TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"("a")");
    TRY(in = make_interval("a"s, Bound::closed, Bound::open));        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"({})");
    TRY(in = make_interval("a"s, Bound::open, Bound::closed));        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"({})");
    TRY(in = make_interval("a"s, Bound::closed, Bound::unbound));     TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(>="a")");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::closed));     TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(<="a")");
    TRY(in = make_interval("a"s, Bound::open, Bound::unbound));       TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(>"a")");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::open));       TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(<"a")");
    TRY(in = make_interval("a"s, Bound::unbound, Bound::unbound));    TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(*)");
    TRY(in = make_interval("a"s, "z"s));                              TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(["a","z"])");
    TRY(in = make_interval("a"s, "z"s, Bound::closed));               TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(["a","z"])");
    TRY(in = make_interval("a"s, "z"s, Bound::open));                 TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(("a","z"))");
    TRY(in = make_interval("a"s, "z"s, Bound::closed, Bound::open));  TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(["a","z"))");
    TRY(in = make_interval("a"s, "z"s, Bound::open, Bound::closed));  TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(("a","z"])");
    TRY(in = make_interval("a"s, "z"s, "[]"));                        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(["a","z"])");
    TRY(in = make_interval("a"s, "z"s, "()"));                        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(("a","z"))");
    TRY(in = make_interval("a"s, "z"s, "[)"));                        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(["a","z"))");
    TRY(in = make_interval("a"s, "z"s, "(]"));                        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(("a","z"])");
    TRY(in = make_interval("a"s, "z"s, "<"));                         TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(<"z")");
    TRY(in = make_interval("a"s, "z"s, "<="));                        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(<="z")");
    TRY(in = make_interval("a"s, "z"s, ">"));                         TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(>"a")");
    TRY(in = make_interval("a"s, "z"s, ">="));                        TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(>="a")");
    TRY(in = make_interval("a"s, "z"s, "*"));                         TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"(*)");
    TRY(in = make_interval("z"s, "a"s));                              TRY(str = std::format("{:?}", in));  TEST_EQUAL(str, R"({})");
...
void test_rs_interval_ordered_interval_from_string() {
    ...
    TRY(in = Itv::from_string("{}"));      TEST_EQUAL(std::format("{}", in), "{}");
    TRY(in = Itv::from_string("*"));       TEST_EQUAL(std::format("{}", in), "*");
    TRY(in = Itv::from_string("a"));       TEST_EQUAL(std::format("{}", in), "a");
    TRY(in = Itv::from_string(">e"));      TEST_EQUAL(std::format("{}", in), ">e");
    TRY(in = Itv::from_string("<e"));      TEST_EQUAL(std::format("{}", in), "<e");
    TRY(in = Itv::from_string(">=e"));     TEST_EQUAL(std::format("{}", in), ">=e");
    TRY(in = Itv::from_string("<=e"));     TEST_EQUAL(std::format("{}", in), "<=e");
    TRY(in = Itv::from_string("e+"));      TEST_EQUAL(std::format("{}", in), ">=e");
    TRY(in = Itv::from_string("e-"));      TEST_EQUAL(std::format("{}", in), "<=e");
    TRY(in = Itv::from_string("[e,j]"));   TEST_EQUAL(std::format("{}", in), "[e,j]");
    TRY(in = Itv::from_string("[e,j)"));   TEST_EQUAL(std::format("{}", in), "[e,j)");
    TRY(in = Itv::from_string("(e,j]"));   TEST_EQUAL(std::format("{}", in), "(e,j]");
    TRY(in = Itv::from_string("(e,j)"));   TEST_EQUAL(std::format("{}", in), "(e,j)");
    TRY(in = Itv::from_string("e-j"));     TEST_EQUAL(std::format("{}", in), "[e,j]");
