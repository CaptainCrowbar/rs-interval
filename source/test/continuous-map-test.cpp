...
void test_rs_continuous_interval_map() {
    ...
    TRY(map.insert(IntervalType(1,4,"()"), "delta"));
    TRY(map.insert(IntervalType(6,8,"[]"), "charlie"));
    ...
    TRY(map.erase(IntervalType(6,8,"()")));
...
void test_rs_continuous_interval_map_hashing() {
