...
void test_rs_interval_boundary_addition() {
    ...
    /* lb=0=empty    rb=0=empty    !lu  !ru  */  b = el1;  b += el2;  TEST_EQUAL(b.str(), "left empty");
    /* lb=0=empty    rb=0=empty    lu   ru   */  b = eu1;  b += eu2;  TEST_EQUAL(b.str(), "right empty");
    /* lb=0=empty    rb=1=closed   !lu  !ru  */  b = el1;  b += cl2;  TEST_EQUAL(b.str(), "left empty");
    /* lb=0=empty    rb=1=closed   lu   ru   */  b = eu1;  b += cu2;  TEST_EQUAL(b.str(), "right empty");
    /* lb=0=empty    rb=2=open     !lu  !ru  */  b = el1;  b += ol2;  TEST_EQUAL(b.str(), "left empty");
    /* lb=0=empty    rb=2=open     lu   ru   */  b = eu1;  b += ou2;  TEST_EQUAL(b.str(), "right empty");
    /* lb=0=empty    rb=3=unbound  !lu  !ru  */  b = el1;  b += ul2;  TEST_EQUAL(b.str(), "left empty");
    /* lb=0=empty    rb=3=unbound  lu   ru   */  b = eu1;  b += uu2;  TEST_EQUAL(b.str(), "right empty");
    /* lb=1=closed   rb=0=empty    !lu  !ru  */  b = cl1;  b += el2;  TEST_EQUAL(b.str(), "left empty");
    /* lb=1=closed   rb=0=empty    lu   ru   */  b = cu1;  b += eu2;  TEST_EQUAL(b.str(), "right empty");
    /* lb=1=closed   rb=1=closed   !lu  !ru  */  b = cl1;  b += cl2;  TEST_EQUAL(b.str(), "left closed 3");
    /* lb=1=closed   rb=1=closed   lu   ru   */  b = cu1;  b += cu2;  TEST_EQUAL(b.str(), "right closed 3");
    /* lb=1=closed   rb=2=open     !lu  !ru  */  b = cl1;  b += ol2;  TEST_EQUAL(b.str(), "left open 3");
    /* lb=1=closed   rb=2=open     lu   ru   */  b = cu1;  b += ou2;  TEST_EQUAL(b.str(), "right open 3");
    /* lb=1=closed   rb=3=unbound  !lu  !ru  */  b = cl1;  b += ul2;  TEST_EQUAL(b.str(), "left unbound");
    /* lb=1=closed   rb=3=unbound  lu   ru   */  b = cu1;  b += uu2;  TEST_EQUAL(b.str(), "right unbound");
    /* lb=2=open     rb=0=empty    !lu  !ru  */  b = ol1;  b += el2;  TEST_EQUAL(b.str(), "left empty");
    /* lb=2=open     rb=0=empty    lu   ru   */  b = ou1;  b += eu2;  TEST_EQUAL(b.str(), "right empty");
    /* lb=2=open     rb=1=closed   !lu  !ru  */  b = ol1;  b += cl2;  TEST_EQUAL(b.str(), "left open 3");
    /* lb=2=open     rb=1=closed   lu   ru   */  b = ou1;  b += cu2;  TEST_EQUAL(b.str(), "right open 3");
    /* lb=2=open     rb=2=open     !lu  !ru  */  b = ol1;  b += ol2;  TEST_EQUAL(b.str(), "left open 3");
    /* lb=2=open     rb=2=open     lu   ru   */  b = ou1;  b += ou2;  TEST_EQUAL(b.str(), "right open 3");
    /* lb=2=open     rb=3=unbound  !lu  !ru  */  b = ol1;  b += ul2;  TEST_EQUAL(b.str(), "left unbound");
    /* lb=2=open     rb=3=unbound  lu   ru   */  b = ou1;  b += uu2;  TEST_EQUAL(b.str(), "right unbound");
    /* lb=3=unbound  rb=0=empty    !lu  !ru  */  b = ul1;  b += el2;  TEST_EQUAL(b.str(), "left empty");
    /* lb=3=unbound  rb=0=empty    lu   ru   */  b = uu1;  b += eu2;  TEST_EQUAL(b.str(), "right empty");
    /* lb=3=unbound  rb=1=closed   !lu  !ru  */  b = ul1;  b += cl2;  TEST_EQUAL(b.str(), "left unbound");
    /* lb=3=unbound  rb=1=closed   lu   ru   */  b = uu1;  b += cu2;  TEST_EQUAL(b.str(), "right unbound");
    /* lb=3=unbound  rb=2=open     !lu  !ru  */  b = ul1;  b += ol2;  TEST_EQUAL(b.str(), "left unbound");
    /* lb=3=unbound  rb=2=open     lu   ru   */  b = uu1;  b += ou2;  TEST_EQUAL(b.str(), "right unbound");
    /* lb=3=unbound  rb=3=unbound  !lu  !ru  */  b = ul1;  b += ul2;  TEST_EQUAL(b.str(), "left unbound");
    /* lb=3=unbound  rb=3=unbound  lu   ru   */  b = uu1;  b += uu2;  TEST_EQUAL(b.str(), "right unbound");
