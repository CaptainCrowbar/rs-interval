...
void test_rs_integral_boundary_formatting() {
...
void test_rs_integral_boundary_from_interval() {
    ...
    TEST_EQUAL(left_boundary_of(c14), (B{1, BT::closed_}));
    ...
    TEST_EQUAL(right_boundary_of(c14), (B{4, BT::closed_}));

}

void test_rs_integral_boundary_to_interval() {
    ...
    static const B cl4 = {4, BT::closed_};
    static const B op4 = {4, BT::open_};
